...
public class MatFileWriter extends FileWriter
{
     ...
     * @param diagram the {@link SLDiagram} we're building
     * @param fileName Name of file to open
     * @throws IOException if unabelt to construct parental FileWriter
     */
     ...
     * @throws IOException if required for underlying FileWriter#write call
     *
     */
     ...
     * @param modelName String containing the name of the model we're documenting
     * @throws IOException if anything goes wrong with underlying FileWriter#write()
     */
     ...
     * @throws IOException if any is generated by called methods
     */
     ...
     * @throws IOException if problem arises in writing to the output stream
     *
     */
